...
Not right now, but that had been my theory when I first read the entry about this arm in the \<Darkness Exploration Records\>.
...
That is, not the Agent Choi I knew from the Darkness Exploration Records.
...
And in the founding days of the \<Darkness Exploration Records\>, back when only the Supernatural Disaster Management Bureau existed, the logs had emphasized the government agency’s core mission—to save civilians.
...
Moreover, they placed more weight on #rending the ghost story itselfr# over rescuing civilians, making occasional civilian casualties an acceptable risk.
$+
...
In return, the bloodstained, crumpled scrap of paper it held dropped to the filthy floor, and I barely managed to catch it.
...
And it’s not like I rashly sacrificed my custom equipment either. I’ve got plans to retrieve it later.
...
$p
@c@ $hd #rLook Herer# hd$ @c@

@c@ $hd #rThat Which Responds To Empathy And Attentionr# hd$ @c@

@c@ $hd #rThere Is A Toyr# hd$ @c@
p$
...
“This place is exactly like Hanyang.[1]{T/N: Hanyang : What Seoul was called during the Joseon period.} The kind where you get robbed in broad daylight, you know? If you watch how your sunbae-nim does it and follow along...”
...
Whether that was a strong sign of suspicion or genuine concern... even I, who’d tracked Agent Choi’s entire history in the \<Darkness Exploration Records\>, couldn’t tell.
...
$p
@c@ $hd #f#That Which Responds To#f# #rEmpathyr# #f#And#f# #rAttentionr# hd$ @c@

@c@ $hd #f#There Is A#f# #rToyr# hd$ @c@
p$
...
Like the address system ‘what3words’, which expresses a 3mX3m location with three words. 
‘If I plug those words into a search...’

Immediately, a small location in the old city center of Seoul comes up.[2]{Editor’s Note: If anyone is curious [here is the link to the location](https://w3w.co/공감.주목.장난감?alias=공감.주목.장난감). The English words for this location is "radio.roadmap.opens"}
...
The word coordinates pointed to a location that slightly veered off from the building itself, a spot tucked awkwardly between a cluster of small commercial buildings.
