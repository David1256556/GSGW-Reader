<script lang="ts">
  ...
  const fontItems = [
    ...
    { syntax: "$h text h$", text: "handwritten text", cls: "paulo-bittencourt", expandable: true },
    { syntax: "$hac text hac$", text: "Agent Choi handwriting", cls: "choi-hand", expandable: true },
    { syntax: "$hne text hne$", text: "orientation handwriting", cls: "incheongyoyugsimin", expandable: true },
    { syntax: "$hd text hd$", text: "desperate handwriting", cls: "kccimkwontaek", expandable: true },


    { syntax: "$Eb text Eb$", text: "old style text", cls: "eb-garamond", expandable: true },
    { syntax: "$osh text osh$", text: "old style humanist", cls: "crimson-old-style", expandable: true },


    { syntax: "$ssr text ssr$", text: "sans serif regular", cls: "noto-sans", expandable: true },
    { syntax: "$sst text sst$", text: "sans serif thin", cls: "nanum-barun-gothic", expandable: true },
    { syntax: "$ips text ips$", text: "IBM Plex Sans", cls: "ibm-plex-sans", expandable: true },
    { syntax: "$lat text lat$", text: "document text", cls: "lato", expandable: true },


    { syntax: "$Bh text Bh$", text: "braun font", cls: "braun-handwriting", expandable: true },
    { syntax: "$fox text fox$", text: "fox counseling text", cls: "fox", expandable: true },
    ...
    { syntax: "$tt text tt$", text: "train sign", cls: "mbc-1961", expandable: true },
    { syntax: "$cri text cri$", text: "cheerful research inc.", cls: "macho", expandable: true },


    { syntax: "$NE text NE$", text: "noto emoji", cls: "noto-emoji", expandable: true, previewHtml: '<span class="noto-emoji">🥰🥸🤯🧐🤪🥱</span>' },
    { syntax: "$soc text soc$", text: "cursive script", cls: "kcc-an-changho", expandable: true },
    { syntax: "$vcr text vcr$", text: "vcr text", cls: "vcr-osd-mono", expandable: true },
  ];

  const colorsItems = [
    { syntax: "$wo text wo$", text: "white outline", cls: "text-black outline-white", expandable: true, previewHtml: '<span class="text-black" style="-webkit-text-stroke:0.15em white;text-stroke:0.15em white;paint-order:stroke fill;">text</span>' },
    { syntax: "$bo text bo$", text: "black outline", cls: "text-green outline-black", expandable: true, previewHtml: '<span class="text-green" style="-webkit-text-stroke:0.15em black;text-stroke:0.15em black;paint-order:stroke fill;">text</span>' },
    { syntax: "$hxo(#ff) text hxo#", text: "hex outline", cls: "hex-outline", expandable: true, previewHtml: '<span class="hex-outline hex-preview" style="--hxo-color:#ff6600">text</span>', meta: "replace #ffffff with any valid hex color" },
    { syntax: "#r text r#", text: "red text", cls: "text-red" },
    { syntax: "#o text o#", text: "orange text", cls: "text-orange" },
    { syntax: "#y text y#", text: "yellow text", cls: "text-yellow" },
    { syntax: "#g text g#", text: "green text", cls: "text-green" },
    { syntax: "#c ytext c y#", text: "cyan text", cls: "text-cyan" },
    { syntax: "#b text b#", text: "blue text", cls: "text-blue" },
    { syntax: "#lp text lp#", text: "purple text", cls: "text-light-purple" },
    { syntax: "#p text p#", text: "magenta text", cls: "text-magenta" },
    { syntax: "#d text d#", text: "black text", cls: "text-base-content" },
    { syntax: "#hx(#ffffff) text hx#", text: "hex text", cls: "text-base-content", expandable: true, previewHtml: '<span class="hex-preview">hex color text</span>', meta: "replace #ffffff with any valid hex number to change the text to this specific color" },
    { syntax: ";r text r;", text: "red highlight", cls: "hl-red" },
    { syntax: ";o text o;", text: "orange highlight", cls: "hl-orange" },
    { syntax: ";y text y;", text: "yellow highlight", cls: "hl-yellow" },
    { syntax: ";g text g;", text: "green highlight", cls: "hl-green" },
    { syntax: ";b text b;", text: "blue highlight", cls: "hl-blue" },
    { syntax: ";p text p;", text: "magenta highlight", cls: "hl-magenta" },
