...
!pb
$sstIn Twinkle Twinkle Ocean Palace, day and night are determined by the chimes of the town clock tower.sst$

$sstWhen night falls, a drowsiness appropriate to children’s sleep cycles sets in. Everyone falls asleep before midnight, and cheerful music plays at sunrise to wake them.sst$
pb!
...
$p
#>< 𝐃𝐫𝐞𝐚𝐦𝐥𝐚𝐧𝐝 𝐁𝐞𝐝𝐬 <br> 𝐟𝐨𝐫 𝐂𝐡𝐢𝐥𝐝𝐫𝐞𝐧 ><#
p$
...
In a dreamlike daze, I slowly made my resolve.
...
$p
[Grapes dear.][1]{T/N: Spoken affectionately; *Podo-ya*}
p$

...Hm?

$p
[Grapes dear. I think you’ll make a fine agent. Your arm thinks so too.]
p$
...
In this dream, I could calmly review them.
...
$p
[Indeed! Clever boy. Grapes dear, a wise idea is a treasure for all time.]
...
Because right now, my mission—and what I *need* most—is to rescue a child.
...
Then sweated even more sorting through non–Daydream Inc. items to trade for it.
...
But... transforming into an animal in a ghost story that requires the form of a *child* to enter... is that really ‘what I need most’ at this very moment?

I felt uneasy, yet at the same time, a chill ran down my spine.

A gut feeling told me I needed to check.
...
$p
The golden city melts away before my eyes.
p$
...
And in their place, horrifying sights appeared. Rusty metal pipes. Flickering, broken streetlamps. Half-collapsed buildings. Scribbles of blood and filth. Grotesque,bulging,ulcer-likemassesfilledthecracksinthebricksandlampposts,pulsatingandoozing.Thewholespaceisinfected!It’swrong!It’swrong!It’severywhere!I’mcontamin—
...
Yes. ‘Twinkle Twinkle Ocean Palace’ wasn’t a ghost story I didn’t know, nor was it an unrecorded one left out of the \<Darkness Exploration Records\> afterall.
...
+$
The city is already in ruins, and based on remaining records it can be inferred that it fell due to #rinfection from a biological disasterr#.
...
If caught, one becomes infected and becomes a host for the merfolk parasite.
$+
...
$p
#>< #f#𝐂𝐡𝐢𝐥𝐝𝐫𝐞𝐧, <br> 𝐏𝐥𝐞𝐚𝐬𝐞 𝐭𝐚𝐤𝐞 𝐲𝐨𝐮𝐫 𝐡𝐨𝐧𝐞𝐲!#f# ><#
p$

Those colorful soldier figurines, and the elephant-shaped ones too...
...
And it was infecting the children. Those horrific infected fluids, called ‘mer-children’ in the \<Darkness Exploration Records\>, were, in the end...
...
Moving on instinct, having fully adapted to this feline body, I dashed between rusted alleyways and rotting ruins. Maybe this was why Agent Choi had recommended it after all.
...
Calm voices. Phrases I recognized from the \<Darkness Exploration Records\>. People addressing each other by job positions.

...Daydream Inc.

‘So a squad of the Field Exploration Team really was dispatched...!’

Of course. Most of the long entries in the Darkness Exploration Records had been written by employees of the company. So it only made sense I’d run into them here.
