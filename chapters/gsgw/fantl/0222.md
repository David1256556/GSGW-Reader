...
$p
#f# *-- First, let's check if it's really a Darkness.* #f#
...
$p
#f# *– So we just don't provoke it, and load everything into the USB as it is!* #f#
...
As soon as the USB was connected, Kang Yihak swiftly opened the removable disk. With practiced ease, she selected every file ending in '6' on the desktop, along with the in-progress editing folder, and dragged them all in at once.

It was a motion she'd done so often it carried no hesitation.

'Huu.'

And then, as expected of massive files, a loading pop-up appeared.
...
When you drag files or folders directly into a USB drive, the system treats it as a *move*.
...
Cold dread trickled through her veins as she stared at the 'Copying' pop-up, waiting for completion.
...
+=
#rAre you sure you want to permanently delete these 6 items?r#
=+
...
<pagebreak>
@c@@@**$EbAmid the lively scene of varietyEb$**@@@c@
@c@@@**$Ebentertainment, from beyond the cameraEb$**@@@c@
@c@@@**$Eba pair of eyes meet yours and yours alone.Eb$**@@@c@
@c@@@**$EbDilated pupils, eyes dark and hollowEb$**@@@c@
@c@@@**$Eblike gaping holes in a face, fixed solely upon you.Eb$**@@@c@
@c@@@**$EbA grin now tugs up his lips, teeth bared.Eb$**@@@c@
@c@@@**$EbHe smiles.Eb$**@@@c@
@c@@@**$EbHe watches.Eb$**@@@c@
@c@@@**$EbThe mouth yawns open, and insideEb$**@@@c@
@c@@@**$Ebwrithes a black void, raw red gums andEb$**@@@c@
@c@@@**$Eba twisting tongue, all frozen mid-motion.Eb$**@@@c@
@c@@@**$EbA mouth that whispers its words, slow and deliberate.Eb$**@@@c@
</pagebreak>
...
@c@@@On the desktop, dozens of video files all played at once. Audio overlapped, lagging, stuttering. Strange noises burst out. Playback positions scrambled, skipping, shutting off and relaunching, switching randomly. The screens flickered. From the screens@@@c@

@c@@@Something was coming out.@@@c@

#>< *@_@%~OOOOOOOOOUUUUUUUUUUUUUUUUNEEEEEUUUUUEEEEEEEEETUUUUUUUEEEEEEEEEEEEUUUUUUUUUUUUUUOOOOOOOOIIIIIIIIIIIIIIIIIEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE~%@_@* ><#

@c@@@The footage stuttered and blinked. Each second switched to another variety show clip, zooming in. And in every one, edited into the scene, was the same presence.@@@c@

<br>

@c@@@The man in the screen@@@c@
...
@c@@@**$EbT H E M A N A P P E A R SEb$**@@@c@
@c@@@**$EbI N A C L O S E U PEb$**@@@c@
@c@@@**$EbI N T H E S C R E E NEb$**@@@c@
@c@@@**$EbM A K I N G H I MEb$**@@@c@
@c@@@**$EbL A R G E R A N DEb$**@@@c@
@c@@@**$EbL A R G E R A N DEb$**@@@c@
@c@@@**$EbL A R G E REb$**@@@c@

<br>

@c@@@**$EbYou are watching the man's mouth.Eb$**@@@c@
...
...Kang Yihak realized her face had been so close to the editing monitor that she had nearly pressed her nose against it.
...
All the more so when it comes to the delicate task of repeatedly closing the frenzied flood of playback pop-ups, finding the files on the desktop, and permanently deleting them!
...
Then, gripping it tightly, she dragged it sharply down to the lower right.
...
Sometimes a video opened first, diverting the icon click. Sometimes, just before completion, hitting the desktop key closed the deletion pop-up.
...
Relying only on touch, she adjusted the pointer, carefully learning Mr. Employee's signals to reduce errors.
...
The pop-up on the unseen monitor Mr. Employee was watching, but she could not see.
...
“We misunderstood somethin', didn’t we?”

Lee Seonghae’s calm voice sent a chill up Kang Yihak’s spine.

“There’s somethin' we missed. Right?”
...
$p
#f# *– As for editing... Only urgent work that absolutely requires the equipment in here is done, and only during the day. Otherwise, we try to do it outside, either in other studios or remotely from home.* #f#
p$
