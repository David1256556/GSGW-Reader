...
......That was all the \<Darkness Exploration Records\> had to say when the company was first introduced.
...
Eventually, as time passed, meaningful exploration logs were added here and there throughout the Darkness Exploration Records, and readers began forming and theorizing several conspiracies about Daydream Inc.
...
The lights were off, and beneath an empty glass tube sat a button panel and keyboard of an old-style experimental machine straight out of the 2000s.

$p
#>< **Dream Incubator** ><#
p$

Beside it was an experimental logbook.
...
![Official Illustration Translated by Sen](ch148_1.webp)
...
You’d think that I would at least try to restore the text buried below, but I gave up right away. And it wasn’t because this was some plot device like in the \<Darkness Exploration Records\> where information would be blocked purposefully to build suspense. It’s just that, I physically could not.
...
Given the circumstances, it is presumed that only vital signs were intentionally preserved. Method undetermined.
$+
...
$p
@c@ <ts>**Cheerful</ts> Researcher** @c@ @c@ ■ ■ ■ @c@
p$
...
While there were no detailed operation logs in the \<Darkness Exploration Records\>, it had clearly stated: *‘Though it looks like an old prototype, it appears to be in proper working condition.’*
...
<!-- Uses a full width square font -->
$p
@r@ $cri DE 000000 cri$ @r@
p$
...
$p
@c@ $cri Detective Syrup for Kids cri$ @c@
@c@ $cri (Cherry Flavor) cri$ @c@
@c@ ★★★ @c@
p$
...
Even in the \<Darkness Exploration Records\>, it took a former Daydream Inc. employee three months to crack the cipher after obtaining it.
