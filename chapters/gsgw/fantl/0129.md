...
A story wasn’t just cosmic horror-themed—it had to be *the* cosmic horror itself.
...
$p
#f# *– Make sure you don’t lose it—those things have serial numbers; it’ll be a real headache if you do.* #f#
p$
...
‘Because it came from a famous game based on the \<Darkness Exploration Records\>...!’
...
+-
\#wh Elite Team Cylinder wh#

A special piece of equipment once produced exclusively for the Elite Team. It was discontinued due to budget constraints after the design was standardized for all team members.
-+
...
“What if we just turn the escape method you used to clear it into an official manual? If we can frame what we did as a documented escape method, it could be considered as work. That way, the company can’t penalize Roe for it, right?” Supervisor Park asked.
